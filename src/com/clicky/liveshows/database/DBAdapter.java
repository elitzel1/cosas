...
public class DBAdapter {
	...
	public long createCortesia(String tipo, int cantidad, int producto_id){
		ContentValues initialValues = createContentValuesCortesia(tipo,cantidad,producto_id);
	...
	public Cursor fetchAllCortesias(){
		...
		return database.query(TABLE_CORTESIAS, new String[] { colIdCortesias,colTipoCortesias,colCantidadCortesias,colProductoCortesia},
				null, null, null,
				null, null);
	}	
	...
	private ContentValues createContentValuesCortesia(String tipo, int cantidad, int id){
		ContentValues values =new ContentValues();
